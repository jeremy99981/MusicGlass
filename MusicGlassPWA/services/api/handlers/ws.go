...
func (h *Handler) ServeWS(c *gin.Context) {
	...
	if tokenStr == "" {
		// Browser clients send the same-origin HttpOnly access cookie during
		// the WebSocket upgrade. Flutter keeps using the query parameter.
		tokenStr, _ = c.Cookie("mg_access")
		if tokenStr == "" {
