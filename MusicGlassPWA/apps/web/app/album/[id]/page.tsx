...
export default function AlbumPage() {
  ...
  if (error || !data) {
    return <div className="page detail-loading detail-error">Impossible de charger l’album.</div>;
  }
  ...
  return (
    <div className="page detail-page album-detail-page">
      ...
      <header className="detail-header">
        ...
        <div className="detail-copy">
          ...
          <div className="detail-meta">
            <Badge variant="soft" size="sm">Album</Badge>
      ...
      <section className="detail-track-list" aria-label="Titres de l’album">
